package cn.sanleny.zuul.sample.filter;

import cn.sanleny.zuul.sample.configuration.MyConfiguration;
import cn.sanleny.zuul.sample.jwt.JwtTokenProvider;
 ...
 * @Author: sanleny
 * @Date: 2019-04-04
 * @Description: cn.sanleny.zuul.sample.filter
 * @Version: 1.0
 */
@Component
public class TokenValidataFilter extends ZuulFilter {
    ...
    public TokenValidataFilter(JwtTokenProvider jwtTokenProvider, MyConfiguration myConfiguration) {
    ...
    public boolean shouldFilter() {
        ...
        return !myConfiguration.getNoAuthenticationRoutes().contains(ctx.get("proxy"));
    }
